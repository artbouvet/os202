...
if __name__ == '__main__':
    ...
    while loop:
        ...
        moy_temps_affichage += (t3-t2)/nb_iterations
        
        print(f"Pattern : {choice}, resolution : {resx,resy}, iterations : {nb_iterations}, moyenne temps calcul : {moy_temps_calcul:2.2e} secondes, moyenne temps affichage : {moy_temps_affichage:2.2e} secondes\r", end='')
